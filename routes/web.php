		...
		*/
		...
		Route::group(['middleware' => 'admin'], function () {
            ...
            */
            ...
            Route::get('visitors','Admin\VisitorsController@index')->name('visitor');
            Route::post('visitors/add', 'Admin\VisitorsController@add');
            Route::get('visitors/edit/{id}', 'Admin\VisitorsController@edit');
            Route::get('visitors/visitor_visiting_history/{id}', 'Admin\VisitorsController@visitor_visiting_history');
            Route::post('visitors/update', 'Admin\VisitorsController@update');
            Route::get('timesheet','Admin\TimesheetController@index')->name('timesheet');
            Route::post('timesheet/clockin','Admin\TimesheetController@addClockIn');
            Route::post('timesheet/clockout','Admin\TimesheetController@addClockOut');
